...
import type { Config, OvertureRelease } from '../core/types'
import { parseNaturalDateToISO } from '../core/utils'
 ...
 */
export async function scrapeReleaseCalendar(
  config: Config,
): Promise<OvertureRelease[]> {
